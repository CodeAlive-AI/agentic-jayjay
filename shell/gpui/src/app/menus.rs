...
use super::actions::{
    ...
    OpenSettings, OpenUserGuide, ReportIssue, ResetZoom, ShowRepoInFileManager,
...
pub fn app_menus(cx: &mut App) -> Vec<Menu> {
    ...
    vec![
        ...
        Menu::new("Repository").items([
            ...
            MenuItem::action("Open in Editor", OpenRepoInEditor),
            MenuItem::action("Open in Terminal", OpenRepoInTerminal),
        ]),
        Menu::new("Help").items([
...
mod tests {
    ...
    fn app_menus_include_cross_platform_sections(cx: &mut gpui::TestAppContext) {
        cx.update(|cx| {
            ...
            assert_action(&menus[4], "Open in Editor");
