...
fn operation_row(
    ...
    div()
        ...
        .child(operation_text(description, timestamp, is_current, fg, &t))
        .child(operation_id(id_prefix, id_rest, &t))
        .into_any_element()
}
    ...
    div()
        ...
        .child(
            div()
                ...
                .child(
                    div()
                        .debug_selector(|| "operation-log-description".to_owned())
                        .flex_1()
                        .min_w_0()
                        .truncate()
                        .text_size(px(13.))
...
fn operation_id(id_prefix: String, id_rest: String, t: &Theme) -> AnyElement {
    div()
        .flex()
        .flex_row()
        .flex_none()
